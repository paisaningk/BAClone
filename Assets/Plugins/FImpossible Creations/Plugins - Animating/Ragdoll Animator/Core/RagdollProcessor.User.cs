...
namespace FIMSpace.FProceduralAnimation
{
    public partial class RagdollProcessor
    {
        ...
        public void User_SetAllLimbsVelocity(Vector3 velocity)
        {
            ...
            while (c != null)
            {
                if (c.rigidbody) c.rigidbody.linearVelocity = velocity;
                c = c.child;
            }
        }
        ...
        public Vector3 User_GetAllLimbsVelocity()
        {
            ...
            while (c != null)
            {
                if (c.rigidbody) velo += c.rigidbody.linearVelocity;
                c = c.child;
            }
        ...
        public Vector3 User_GetAllLimbsMaxVelocity()
        {
            ...
            while (c != null)
            {
                if (c.rigidbody) if (c.rigidbody.linearVelocity.sqrMagnitude > velo.sqrMagnitude) velo = c.rigidbody.linearVelocity;
                c = c.child;
            }
        ...
        public Vector3 User_GetSpineLimbsVelocity(bool withChest = false)
        {
            ...
            else velo += posingPelvis.rigidbody.linearVelocity;

            if (withChest) velo += posingChest.rigidbody.linearVelocity;
